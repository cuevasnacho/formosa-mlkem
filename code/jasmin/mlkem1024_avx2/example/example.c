...
#define JADE_KEM_SECRETKEYBYTES JADE_KEM_mlkem_mlkem1024_amd64_avx2_SECRETKEYBYTES
#define JADE_KEM_PUBLICKEYBYTES JADE_KEM_mlkem_mlkem1024_amd64_avx2_PUBLICKEYBYTES
#define JADE_KEM_CIPHERTEXTBYTES JADE_KEM_mlkem_mlkem1024_amd64_avx2_CIPHERTEXTBYTES
#define JADE_KEM_KEYPAIRCOINBYTES JADE_KEM_mlkem_mlkem1024_amd64_avx2_KEYPAIRCOINBYTES
#define JADE_KEM_ENCCOINBYTES JADE_KEM_mlkem_mlkem1024_amd64_avx2_ENCCOINBYTES
#define JADE_KEM_BYTES JADE_KEM_mlkem_mlkem1024_amd64_avx2_BYTES

#define jade_kem_keypair jade_kem_mlkem_mlkem1024_amd64_avx2_keypair
#define jade_kem_enc jade_kem_mlkem_mlkem1024_amd64_avx2_enc
#define jade_kem_dec jade_kem_mlkem_mlkem1024_amd64_avx2_dec

#define jade_kem_keypair_derand jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_derand
#define jade_kem_enc_derand jade_kem_mlkem_mlkem1024_amd64_avx2_enc_derand

#define JADE_KEM_ALGNAME JADE_KEM_mlkem_mlkem1024_amd64_avx2_ALGNAME
#define JADE_KEM_ARCH JADE_KEM_mlkem_mlkem1024_amd64_avx2_ARCH
#define JADE_KEM_IMPL JADE_KEM_mlkem_mlkem1024_amd64_avx2_IMPL
